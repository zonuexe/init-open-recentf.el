...
#+BEGIN_HTML
<a href="http://melpa.org/#/init-open-recentf"><img alt="MELPA init-open-recentf" src="http://melpa.org/packages/init-open-recentf-badge.svg"</a>
<a href="http://stable.melpa.org/#/init-open-recentf"><img alt="MELPA stable: init-open-recentf" src="http://stable.melpa.org/packages/init-open-recentf-badge.svg"></a>
#+END_HTML
